...
# Load E_frac array
E_fracs = np.load('Efracs_after_relaxation.npy')

# Load the survival fractions computed using the sequential stripping model including relaxation 
survival_fractions_c_10 = np.load(r"survival_fractions_after_relaxation_c_10.npy")
survival_fractions_c_30 = np.load(r"survival_fractions_after_relaxation_c_30.npy")
survival_fractions_c_100 = np.load(r"survival_fractions_after_relaxation_c_100.npy")
survival_fractions_c_500 = np.load(r"survival_fractions_after_relaxation_c_500.npy")
...
ax.loglog([], [], color="black", label="Analytical (with relaxation)")
...
ax.loglog([], [], color="black", linestyle="dashed", label="S2023's fitting function")
...
ax.legend(ncol=2, loc="lower left", bbox_to_anchor=(0.54,0.90), fontsize = 10)
if save_to_disk:
    fig.savefig("SF vs Efrac; sequential stripping with relaxation; with zoom.pdf")
