...
# Load E_frac array
E_fracs = np.load('Efracs_switching.npy')

# Load the survival fractions computed using the switching procedure
survival_fractions_c_10 = np.load(r"survival_fractions_switching_c_10.npy")
survival_fractions_c_30 = np.load(r"survival_fractions_switching_c_30.npy")
survival_fractions_c_100 = np.load(r"survival_fractions_switching_c_100.npy")
survival_fractions_c_500 = np.load(r"survival_fractions_switching_c_500.npy")
...
ax.loglog([], [], color="black", label="Analytical (switching)")
...
ax.legend(ncol=2, loc="lower left", bbox_to_anchor=(0.54,0.91), fontsize = 10)
if save_to_disk:
    fig.savefig("SF vs Efrac; switching; with zoom.pdf")
